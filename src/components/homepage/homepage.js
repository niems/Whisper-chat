                        ...
                        <main id='homepage' className='wrapper main'>
                            <header>
                                <div className='row space-between'>
                                    <Link className='link-to' to={`${basePath}create-account`}>Create Account</Link>
                                    { isUserAuthenticated.status ? 
                                      <Link className='link-to' to={`${basePath}profile`}>Profile</Link> :
                                      <Link className='link-to' to={`${basePath}login`}>Login</Link>
                                    }
                                </div>
